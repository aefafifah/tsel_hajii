...
public function update(Request $request, $id)
{
    $validatedData = $request->validate([
        ...
        'merchandises' => 'nullable|array',
        'merchandises.*' => 'exists:merchandises,id',
        'ganti_stok' => 'nullable|boolean',
        'stok_option' => 'nullable|in:ganti,tambah',
    ]);
    $produk = Produk::findOrFail($id);
    if ($request->stok_option === 'ganti') {
        $stok_baru = $validatedData['produk_stok'];
    } elseif ($request->stok_option === 'tambah') {
        $stok_baru = $produk->produk_stok + $validatedData['produk_stok'];
    } else {
