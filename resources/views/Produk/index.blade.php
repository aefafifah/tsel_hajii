                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <p class="card-text"><strong>Stok:</strong> Rp
                                    ...
                                    <span>
                                        @if ($produk->merchandises->isNotEmpty())
                                            @foreach ($produk->merchandises as $merchandise)
                                                {{ $merchandise->merch_nama }}@if (!$loop->last)
                                                    ,
                                                @endif
                                            @endforeach
                                        @else
                            ...
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    <h5 class="card-title font-weight-bold" style="color: black;">
                                        {{ $produk->produk_nama }}</h5>
                                    <p class="card-text"><strong>Harga:</strong> Rp
                                        {{ number_format($produk->produk_harga, 0, ',', '.') }}</p>
                                    <p class="card-text"><strong>Diskon:</strong> Rp
                                        {{ number_format($produk->produk_diskon ?? 0, 0, ',', '.') }}</p>
                                    <p class="card-text"><strong>Insentif:</strong>
                                        Rp{{ number_format($produk->produk_insentif ?? 0, 0, ',', '.') }}</p>
                                    <p class="card-text"><strong>Harga Final:</strong>
                                        Rp{{ number_format($produk->produk_harga_akhir ?? 0, 0, ',', '.') }}</p>
                                    <p class="card-text"><strong>Stok:</strong> {{ $produk->produk_stok }}</p>
                                    <p class="card-text">
                                        <strong>Merchandise:</strong>
                                        <span>
                                    ...
                                    <p class="card-text"><strong>Tanggal Dihapus:</strong>
                                        {{ $produk->deleted_at->format('d M Y H:i') }}</p>
                                    <div class="d-flex justify-content-between mt-3">
