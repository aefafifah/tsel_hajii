<x-supvis.supvislayouts>
    <main class="content">
        ...
        <div class="container" style="text-align: center; padding: 20px; font-family: 'Poppins', sans-serif;">
            ...
            <div
                style="display: flex; flex-direction: column; align-items: center; background-color: #f3f4f6; border-radius: 12px; padding: 20px; margin-bottom: 20px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); width: 100%; max-width: 800px;">
                <div style="text-align: center; margin-bottom: 15px;">
                    <h1 style="font-size: 1.8rem; color: #333; margin: 0;">Selamat, {{ Auth::user()->name }}! 🎉</h1>
                    <p style="color: #555; font-size: 1rem; margin: 10px 0;">Anda telah mencapai peningkatan penjualan
                        sebesar 72% hari ini.</p>
                </div>
                <div>
                    <img src="{{ asset('admin_asset/img/photos/icon_spv.png') }}" alt="Illustration"
            ...
            <div class="dashboard-container"
                ...
                <div class="info-box"
                    style="border-radius: 12px; padding: 15px; text-align: center; background-color: #ffffff; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
            ...
            <div style="margin-top: 30px;">
                <div
                    style="background-color: #ffffff; border-radius: 12px; padding: 15px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1); margin-bottom: 15px;">
        ...
        <a href="{{ route('supvis.budget_insentif.index') }}" style="text-decoration: none;">
            <div class="info-box"
                style="border-radius: 12px; padding: 15px; text-align: center; background-color: #ffffff; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);">
                <h3 style="font-size: 1rem; color: #333;">
                    Sisa Budget:
                </h3>
                <p style="font-size: 1.5rem; font-weight: bold; color: #4caf50;">IDR {{ number_format($sisaBudget) }}
                </p>
                <p style="font-size: 0.8rem; color: #555;">dari Total Insentif keluar sebesar
                    {{ number_format($totalInsentif) }}</p>
            </div>
        </a>
    </main>
