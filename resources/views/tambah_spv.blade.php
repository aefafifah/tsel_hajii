    ...
    <div class="container">
        ...
        <form id="addSupervisorForm">
            <div class="form-group">
                ...
                <input type="text" id="name" placeholder="Masukkan nama supervisor" oninput="validateName(this)">
            ...
            <button type="button" class="btn" onclick="addSupervisor()">Tambah Supervisor</button>
        </form>
    </div>
        ...
        function addSupervisor() {
            ...
            if (isValid) {
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil',
                    text: 'Data supervisor berhasil ditambahkan'
                });
