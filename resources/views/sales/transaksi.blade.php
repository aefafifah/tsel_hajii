    ...
    <head>
        ...
        <style>
            ...
            .container {
                ...
                margin: 30px auto;
                /* Memberi jarak dengan bagian atas */
                background: none;
                /* Hapus background putih */
                border-radius: 0;
                /* Hapus sudut membulat */
                overflow: visible;
                /* Izinkan konten keluar */
                box-shadow: none;
            ...
            form {
                padding: 30px;
                /* Memperbesar jarak antar elemen */
            }

            .form-group {
                margin-bottom: 25px;
                /* Memberi jarak antar grup form */
            }
            ...
            @media (max-width: 768px) {
                .checkbox-box {
                    width: 30%;
                    /* Menyesuaikan agar 3 kotak per baris */
                }
            }
    ...
    <body>
        @if (session('alert'))
                ...
                <form action="{{ url('sales/transaksi/submit') }}" method="POST">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_Sales" placeholder="Masukkan nama Sales"
                                oninput="restrictNameInput(this)" required>
                            <small id="error-message-name" style="color: red; display: none;">Harap masukkan hanya huruf
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="checkbox-group">
                                ...
                                <div class="checkbox-box">
                                    <input type="radio" id="paket4" name="paket"
                                        value="11GB_INTERNET_20D_490000">
                                    <label for="paket4">
                                        <span class="checkbox-icon"></span>
                                ...
                                <div class="checkbox-box">
                                    <input type="radio" id="paket5" name="paket"
                                        value="17GB_INTERNET_30D_700000">
                                    <label for="paket5">
                                        <span class="checkbox-icon"></span>
                                ...
                                <div class="checkbox-box">
                                    <input type="radio" id="paket6" name="paket"
                                        value="23GB_INTERNET_45D_855000">
                                    <label for="paket6">
                                        <span class="checkbox-icon"></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="checkbox-group">
                            ...
                            <div class="checkbox-box">
                                <input type="radio" id="metode2" name="metode_pembayaran" value="non_tunai"
                                    required>
                                <label for="metode2">
                                    <span class="checkbox-icon"></span>
                                    Non Tunai
            ...
            <div class="form-group" style="text-align: center; margin-top: 20px;">
                ...
                <button type="button" onclick="OkeForm()"
                    style="
            padding: 10px 20px;
            margin-right: 10px;
            font-size: 16px;
